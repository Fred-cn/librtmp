...
#ifndef __AdtsHeader__adts__h
#define __AdtsHeader__adts__h
...
// 解析buff中的adts固定部分头信息
extern void get_fixed_header(const unsigned char *buff, adts_fixed_header *header);
...
extern void convert_adts_header2int64(const adts_fixed_header *fixed_header, const adts_variable_header *variable_header, unsigned long long *header);
