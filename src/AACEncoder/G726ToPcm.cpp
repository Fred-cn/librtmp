...
{
	m_nG7xxType = AudioCodec_Law_G726;
...
{
	//iRet = g726_decode(g_state726_16, (short*)ucOutBuff, ucInBuff,30);//   120 行
	//iRet = g726_decode(g_state726_24, (short*)ucOutBuff, ucInBuff, 30);//   80 行
